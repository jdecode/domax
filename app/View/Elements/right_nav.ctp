<div id="right-nav">
    ...
    <div class="right-nav-back">
        ...
        <ul>
            ...
            <li><a href="#">Taxation – Direct & Indirect</a></li>
            <li><a href="#">Backend Accounting Services</a></li>
            <li><a href="#">Business Consultancy</a></li>
            <li><a href="#">Project Management</a></li>
            <li><a href="#">Excise</a></li>
            <li><a href="#" style="background-image: none;">Service Tax</a></li>
        </ul>
        <br />
    ...
    <div class="right-nav-back">
        ...
        <div id="subscribe">
            <form action="yourformmailhere" enctype="multipart/form-data" method="post">
                ...
                <textarea name="Message" cols="10" rows="10" class="inputstyle">Message</textarea>
