...
<div class="col-md-12">
	<div class="content-panel">
		<table class="table table-striped table-advance table-hover">
			<h4><i class="fa fa-angle-right"></i> Sent </h4>
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo h($s_data['SentUpload']['id']); ?>&nbsp;</td>
					<td>
						<?php echo $this->Html->link($s_data['User']['username'], array('controller' => 'users', 'action' => 'view', $s_data['User']['id'])); ?>
					<!--,$s_data['User']['username'], array('controller' => 'users', 'action' => 'view', $s_data['User']['id'])-->
					</td>
					
					<td><?php echo $this->Html->link($s_data['Uploads']['filename'], '/app/webroot/files/uploads/' . $s_data['User']['id'] . '/' . $s_data['Uploads']['filename']); ?>&nbsp;</td>
					<td><?php echo $this->Html->link($users[$s_data['SentUpload']['sent_from']], array('controller' => 'users', 'action' => 'view', $s_data['SentUpload']['sent_from'])); ?>&nbsp;</td>
