...
<div class="col-lg-8 form-main">
	<div class="form-panel">
		...
		<div class="form-group d-d">
			...
			<div class="col-sm-9">
		<?php echo $this->Form->input('drop_down', array('label' => '', 'type' => 'select', 'id' => 'UploadDropDown', 'options' => array('' => '--select--', '6' => 'Admin'))); ?>
			</div>
		</div>
...
<div class="input-group input-group-md">	<!--<span class="input-group-addon"><a class="help-box" rel="popover" data-placement="top" data-original-title="" data-content=""><i class=" icon-music"></i></a></span>-->
	...
	<div class="row">
		<div class="col-sm-3"><?php echo $this->Html->link('Back', array("controller" => "uploads", "action" => "inbox", 'client' => true), array("class" => "btn btn-theme")); ?></div>
